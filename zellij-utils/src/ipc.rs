...
impl Display for ClientToServerMsg {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ClientToServerMsg::ConfigWrittenToDisk(..) => {
                write!(f, "ClientToServerMsg::ConfigWrittenToDisk")
            },
            ClientToServerMsg::FailedToWriteConfigToDisk(..) => {
                write!(f, "ClientToServerMsg::FailedToWriteConfigToDisk")
            },
        }
    }
}
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ServerToClientMsg::WriteConfigToDisk { .. } => {
                write!(f, "ServerToClientMsg::WriteConfigToDisk")
            },
        }
    }
}
